...
class TableKeyMap(Enum):
    acct_id = "ACCOUNT"
    actv_code_id = "ACTVCODE"
    actv_code_type_id = "ACTVTYPE"
    asgnmnt_catg_type_id = "ASGNMNTCATTYPE"
    asgnmnt_catg_id = "ASGNMNTCATVAL"
    budg_chng_id = "BUDGCHNG"
    clndr_id = "CALENDAR"
    cost_type_id = "COSTTYPE"
    curr_id = "CURRTYPE"
    doc_catg_id = "DOCCATG"
    doc_status_id = "DOCSTAT"
    doc_id = "DOCUMENT"
    fin_dates_id = "FINDATES"
    fund_id = "FUNDSRC"
    memo_type_id = "MEMOTYPE"
    nonwork_type_id = "NONWORK"
    obs_id = "OBS"
    proj_catg_type_id = "PCATTYPE"
    proj_catg_id = "PCATVAL"
    phase_id = "PHASE"
    pobs_id = "POBS"
    cost_item_id = "PROJCOST"
    proj_id = "PROJECT"
    proj_est_id = "PROJEST"
    proj_fund_id = "PROJFUND"
    issue_id = "PROJISSU"
    thresh_id = "PROJTHRS"
    wbs_id = "PROJWBS"
    risk_id = "PRORISK"
    rsrc_catg_type_id = "RCATTYPE"
    rsrc_catg_id = "RCATVAL"
    risk_type_id = "RISKTYPE"
    role_catg_type_id = "ROLECATTYPE"
    role_catg_id = "ROLECATVAL"
    rolelimit_id = "ROLELIMIT"
    role_rate_id = "ROLERATE"
    role_id = "ROLES"
    rsrc_id = "RSRC"
    curv_id = "RSRCCURV"
    rsrc_level_list_id = "RSRCLEVELLIST"
    rsrc_rate_id = "RSRCRATE"
